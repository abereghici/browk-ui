...
// Given "@browk-ui/design-tokens/dist/themes/index.js"
// Returns ["@browk-ui", "design-tokens", "dist/themes.index.js"]
...
function customResolver(package, details) {
  if (package.includes('@browk-ui/')) {
    const [packageScope, packageName, packagePath] = getPackageParts(package);

    // If we're digging into a Browk UI package (example: @browk-ui/design-tokens/dist/themes/sendgrid/tokens.es6)
