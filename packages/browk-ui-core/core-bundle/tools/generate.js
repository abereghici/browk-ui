...
(async () => {
  ...
  const filteredCorePackageList = sortedPackageList.filter((item) => item.location.includes('/browk-ui-core/'));
  ...
  writeToFile(CORE_BUNDLE_INDEX_PATH, indexOutput, {
    successMessage: `[@browk-ui/core] Exports have been successfully updated within: ${CORE_BUNDLE_INDEX_PATH}`,
  });
  ...
  writeToFile(CORE_BUNDLE_PACKAGE_PATH, newPackageJsonString, {
    successMessage: `[@browk-ui/core] Successfully updated dependencies.`,
  });
})();
