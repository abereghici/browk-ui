...
describe('color', () => {
  ...
  it('should set a responsive color property', (): void => {
    const tree = renderer
      .create(
        <Theme.Provider theme="default">
          <Text as="span" color={['colorText', 'colorTextInverse']}>
            color responsive
          </Text>
        </Theme.Provider>
      )
      ...
      .create(
        <Theme.Provider theme="default">
          <Text
            ...
            _active={{color: 'colorText'}}
            _focus={{color: 'colorText'}}
            _visited={{color: 'colorText'}}
            ...
            _last={{color: 'colorText'}}
            _expanded={{color: 'colorText'}}
            _grabbed={{color: 'colorText'}}
            _notFirst={{color: 'colorText'}}
            _notLast={{color: 'colorText'}}
            _before={{content: `"Before text"`, position: 'absolute', bottom: 0, left: 0}}
            _after={{content: `"After text"`, position: 'absolute', bottom: 0, left: 0}}
            _focusWithin={{color: 'colorText'}}
          >
            PseudoBox
          </Text>
        </Theme.Provider>
...
describe('HTML attributes', () => {
  it('should set a default element data attribute', () => {
    ...
    expect(screen.getByText('text').getAttribute('data-browk-ui-element')).toEqual('TEXT');
  });
  it('should set a custom element data attribute', () => {
    ...
    expect(screen.getByText('text').getAttribute('data-browk-ui-element')).toEqual('bar');
  });
});
...
describe('Customization', () => {
  it('should add custom styles to a component provided as element styles on the customization provider', (): void => {
    render(
      <CustomizationProvider
        baseTheme="default"
        elements={{CUSTOM_TEXT: {color: 'colorText', textDecoration: 'underline'}}}
      >
  ...
  it('should add custom styles to pseudo selectors when provided as element styles on the customization provider', (): void => {
    render(
      <CustomizationProvider baseTheme="default" elements={{CUSTOM_TEXT: {':hover': {color: 'colorTextInverse'}}}}>
        <CustomizableTextExample element="CUSTOM_TEXT" data-testid="customizable-box">
          Custom Box
        </CustomizableTextExample>
      </CustomizationProvider>
  ...
  it('should override existing variant styles when provided as element styles on the customization provider', (): void => {
    render(
      <CustomizationProvider
        baseTheme="default"
        elements={{CUSTOM_TEXT: {variants: {primary: {color: 'colorTextInverse'}}}}}
      >
        <CustomizableTextExample element="CUSTOM_TEXT" variant="primary" data-testid="customizable-box">
          Custom Box
        </CustomizableTextExample>
