...
import {Separator} from '@browk-ui/separator';
...
export const PseudoClassesWithHoverPseudoProps = (): React.ReactNode => {
  return (
    <Text
      ...
      _before={{content: `"Before text"`, position: 'absolute', bottom: 0, left: 0, color: 'colorText'}}
      _after={{content: `"After text"`, position: 'absolute', bottom: 0, right: 0, color: 'colorTextLink'}}
    >
      Hover this text
    </Text>
  );
