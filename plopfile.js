...
module.exports = function (plop) {
  ...
  plop.setGenerator('create-package', {
    ...
    actions: [
      {
        type: 'add',
        path: 'packages/browk-ui-core/{{component-type}}/{{kebabCase component-name}}/src/index.tsx',
        templateFile: 'tools/plop-templates/component-index.hbs',
      },
      {
        type: 'add',
        path: 'packages/browk-ui-core/{{component-type}}/{{kebabCase component-name}}/__tests__/index.spec.tsx',
        templateFile: 'tools/plop-templates/component-tests.hbs',
      },
      {
        type: 'add',
        path: 'packages/browk-ui-core/{{component-type}}/{{kebabCase component-name}}/stories/index.stories.tsx',
        templateFile: 'tools/plop-templates/component-stories.hbs',
      },
      {
        type: 'add',
        path: 'packages/browk-ui-core/{{component-type}}/{{kebabCase component-name}}/build.js',
        templateFile: 'tools/plop-templates/build.hbs',
      },
      {
        type: 'add',
        path: 'packages/browk-ui-core/{{component-type}}/{{kebabCase component-name}}/package.json',
        templateFile: 'tools/plop-templates/package.hbs',
      },
      {
        type: 'add',
        path: 'packages/browk-ui-core/{{component-type}}/{{kebabCase component-name}}/tsconfig.json',
